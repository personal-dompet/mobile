...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(page: BillPlanFormRoute.page),
    AutoRoute(page: BillPlanListRoute.page),
    AutoRoute(page: BillPlanDetailRoute.page),
    AutoRoute(page: BillPlanBillsRoute.page),
