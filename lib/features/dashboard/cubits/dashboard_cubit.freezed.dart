...
mixin _$DashboardState {
 ...
 DashboardSectionStatus get balanceStatus; int get balance; String? get balanceError; DashboardSectionStatus get summaryStatus; TransactionSummary get summary; String? get summarayError; DashboardSectionStatus get recentActivitiesStatus; List<JournalEntry> get recentActivities; String? get recentActivitiesError; DashboardSectionStatus get presetAssetAccountsStatus; List<Account> get presetAssetAccounts; String? get presetAssetAccountsError;/// Total tagihan tertunda (banner). Null = belum dimuat/gagal → sembunyi.
 int? get pendingBillsTotal;/// Tagihan unpaid yang sudah diingatkan (reminded_at <= now).
/// Null = belum dimuat/gagal → sembunyi.
 int? get remindedDueCount; int? get remindedOverdueCount;/// Jumlah dompet cair (subtitle). Null = belum dimuat/gagal → sembunyi.
 int? get liquidAssetCount;/// Ringkasan bulan ini (subtitle + kartu laporan). Null = memuat.
 int? get monthAllocated; int? get monthlyIncome; int? get monthlyExpense;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DashboardState&&(identical(other.balanceStatus, balanceStatus) || other.balanceStatus == balanceStatus)&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.balanceError, balanceError) || other.balanceError == balanceError)&&(identical(other.summaryStatus, summaryStatus) || other.summaryStatus == summaryStatus)&&(identical(other.summary, summary) || other.summary == summary)&&(identical(other.summarayError, summarayError) || other.summarayError == summarayError)&&(identical(other.recentActivitiesStatus, recentActivitiesStatus) || other.recentActivitiesStatus == recentActivitiesStatus)&&const DeepCollectionEquality().equals(other.recentActivities, recentActivities)&&(identical(other.recentActivitiesError, recentActivitiesError) || other.recentActivitiesError == recentActivitiesError)&&(identical(other.presetAssetAccountsStatus, presetAssetAccountsStatus) || other.presetAssetAccountsStatus == presetAssetAccountsStatus)&&const DeepCollectionEquality().equals(other.presetAssetAccounts, presetAssetAccounts)&&(identical(other.presetAssetAccountsError, presetAssetAccountsError) || other.presetAssetAccountsError == presetAssetAccountsError)&&(identical(other.pendingBillsTotal, pendingBillsTotal) || other.pendingBillsTotal == pendingBillsTotal)&&(identical(other.remindedDueCount, remindedDueCount) || other.remindedDueCount == remindedDueCount)&&(identical(other.remindedOverdueCount, remindedOverdueCount) || other.remindedOverdueCount == remindedOverdueCount)&&(identical(other.liquidAssetCount, liquidAssetCount) || other.liquidAssetCount == liquidAssetCount)&&(identical(other.monthAllocated, monthAllocated) || other.monthAllocated == monthAllocated)&&(identical(other.monthlyIncome, monthlyIncome) || other.monthlyIncome == monthlyIncome)&&(identical(other.monthlyExpense, monthlyExpense) || other.monthlyExpense == monthlyExpense));
}


@override
int get hashCode => Object.hashAll([runtimeType,balanceStatus,balance,balanceError,summaryStatus,summary,summarayError,recentActivitiesStatus,const DeepCollectionEquality().hash(recentActivities),recentActivitiesError,presetAssetAccountsStatus,const DeepCollectionEquality().hash(presetAssetAccounts),presetAssetAccountsError,pendingBillsTotal,remindedDueCount,remindedOverdueCount,liquidAssetCount,monthAllocated,monthlyIncome,monthlyExpense]);

@override
String toString() {
  return 'DashboardState(balanceStatus: $balanceStatus, balance: $balance, balanceError: $balanceError, summaryStatus: $summaryStatus, summary: $summary, summarayError: $summarayError, recentActivitiesStatus: $recentActivitiesStatus, recentActivities: $recentActivities, recentActivitiesError: $recentActivitiesError, presetAssetAccountsStatus: $presetAssetAccountsStatus, presetAssetAccounts: $presetAssetAccounts, presetAssetAccountsError: $presetAssetAccountsError, pendingBillsTotal: $pendingBillsTotal, remindedDueCount: $remindedDueCount, remindedOverdueCount: $remindedOverdueCount, liquidAssetCount: $liquidAssetCount, monthAllocated: $monthAllocated, monthlyIncome: $monthlyIncome, monthlyExpense: $monthlyExpense)';
}
...
@useResult
$Res call({
 DashboardSectionStatus balanceStatus, int balance, String? balanceError, DashboardSectionStatus summaryStatus, TransactionSummary summary, String? summarayError, DashboardSectionStatus recentActivitiesStatus, List<JournalEntry> recentActivities, String? recentActivitiesError, DashboardSectionStatus presetAssetAccountsStatus, List<Account> presetAssetAccounts, String? presetAssetAccountsError, int? pendingBillsTotal, int? remindedDueCount, int? remindedOverdueCount, int? liquidAssetCount, int? monthAllocated, int? monthlyIncome, int? monthlyExpense
});
...
/// Create a copy of DashboardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? balanceStatus = null,Object? balance = null,Object? balanceError = freezed,Object? summaryStatus = null,Object? summary = null,Object? summarayError = freezed,Object? recentActivitiesStatus = null,Object? recentActivities = null,Object? recentActivitiesError = freezed,Object? presetAssetAccountsStatus = null,Object? presetAssetAccounts = null,Object? presetAssetAccountsError = freezed,Object? pendingBillsTotal = freezed,Object? remindedDueCount = freezed,Object? remindedOverdueCount = freezed,Object? liquidAssetCount = freezed,Object? monthAllocated = freezed,Object? monthlyIncome = freezed,Object? monthlyExpense = freezed,}) {
...
as String?,pendingBillsTotal: freezed == pendingBillsTotal ? _self.pendingBillsTotal : pendingBillsTotal // ignore: cast_nullable_to_non_nullable
as int?,remindedDueCount: freezed == remindedDueCount ? _self.remindedDueCount : remindedDueCount // ignore: cast_nullable_to_non_nullable
as int?,remindedOverdueCount: freezed == remindedOverdueCount ? _self.remindedOverdueCount : remindedOverdueCount // ignore: cast_nullable_to_non_nullable
as int?,liquidAssetCount: freezed == liquidAssetCount ? _self.liquidAssetCount : liquidAssetCount // ignore: cast_nullable_to_non_nullable
as int?,monthAllocated: freezed == monthAllocated ? _self.monthAllocated : monthAllocated // ignore: cast_nullable_to_non_nullable
as int?,monthlyIncome: freezed == monthlyIncome ? _self.monthlyIncome : monthlyIncome // ignore: cast_nullable_to_non_nullable
as int?,monthlyExpense: freezed == monthlyExpense ? _self.monthlyExpense : monthlyExpense // ignore: cast_nullable_to_non_nullable
as int?,
  ));
}
/// Create a copy of DashboardState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DashboardSectionStatus balanceStatus,  int balance,  String? balanceError,  DashboardSectionStatus summaryStatus,  TransactionSummary summary,  String? summarayError,  DashboardSectionStatus recentActivitiesStatus,  List<JournalEntry> recentActivities,  String? recentActivitiesError,  DashboardSectionStatus presetAssetAccountsStatus,  List<Account> presetAssetAccounts,  String? presetAssetAccountsError,  int? pendingBillsTotal,  int? remindedDueCount,  int? remindedOverdueCount,  int? liquidAssetCount,  int? monthAllocated,  int? monthlyIncome,  int? monthlyExpense)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardState() when $default != null:
return $default(_that.balanceStatus,_that.balance,_that.balanceError,_that.summaryStatus,_that.summary,_that.summarayError,_that.recentActivitiesStatus,_that.recentActivities,_that.recentActivitiesError,_that.presetAssetAccountsStatus,_that.presetAssetAccounts,_that.presetAssetAccountsError,_that.pendingBillsTotal,_that.remindedDueCount,_that.remindedOverdueCount,_that.liquidAssetCount,_that.monthAllocated,_that.monthlyIncome,_that.monthlyExpense);case _:
  return orElse();
...
@override final  int? pendingBillsTotal;
/// Tagihan unpaid yang sudah diingatkan (reminded_at <= now).
/// Null = belum dimuat/gagal → sembunyi.
@override final  int? remindedDueCount;
@override final  int? remindedOverdueCount;
/// Jumlah dompet cair (subtitle). Null = belum dimuat/gagal → sembunyi.
@override final  int? liquidAssetCount;
/// Ringkasan bulan ini (subtitle + kartu laporan). Null = memuat.
@override final  int? monthAllocated;
...
@override
int get hashCode => Object.hashAll([runtimeType,balanceStatus,balance,balanceError,summaryStatus,summary,summarayError,recentActivitiesStatus,const DeepCollectionEquality().hash(_recentActivities),recentActivitiesError,presetAssetAccountsStatus,const DeepCollectionEquality().hash(_presetAssetAccounts),presetAssetAccountsError,pendingBillsTotal,remindedDueCount,remindedOverdueCount,liquidAssetCount,monthAllocated,monthlyIncome,monthlyExpense]);
...
/// Create a copy of DashboardState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? balanceStatus = null,Object? balance = null,Object? balanceError = freezed,Object? summaryStatus = null,Object? summary = null,Object? summarayError = freezed,Object? recentActivitiesStatus = null,Object? recentActivities = null,Object? recentActivitiesError = freezed,Object? presetAssetAccountsStatus = null,Object? presetAssetAccounts = null,Object? presetAssetAccountsError = freezed,Object? pendingBillsTotal = freezed,Object? remindedDueCount = freezed,Object? remindedOverdueCount = freezed,Object? liquidAssetCount = freezed,Object? monthAllocated = freezed,Object? monthlyIncome = freezed,Object? monthlyExpense = freezed,}) {
